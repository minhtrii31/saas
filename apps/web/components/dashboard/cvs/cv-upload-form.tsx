...
export function CvUploadForm({
  ...
  return (
    <section className="border border-[#e5e5df] bg-[#ffffff] p-5 shadow-sm shadow-zinc-950/[0.02]">
      ...
      >
        <div>
          ...
          <input
            ...
            required
            className="mt-2 block w-full cursor-pointer border border-dashed border-[#cfcfc8] bg-[#f7f7f4] px-3 py-5 text-sm text-[#171717] outline-none transition file:mr-3 file:border-0 file:bg-[#171717] file:px-3 file:py-2 file:text-xs file:font-semibold file:text-white hover:border-[#171717] hover:bg-white focus:border-[#171717]"
          />
        ...
        {status.type === "success" ? (
          <p
            role="status"
            className="border border-[#cfcfc8] bg-[#f1f1ee] px-3 py-2 text-sm text-[#343430]"
          >
            {status.message}
          </p>
        ) : null}
        ...
        <button
          ...
          className="flex w-full items-center justify-center gap-2 bg-[#171717] px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[#2b2926] disabled:cursor-not-allowed disabled:bg-[#a1a19a]"
        >
          <Upload className="h-4 w-4" aria-hidden="true" />
